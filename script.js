...
// YouTube API for autoplay videos
var player1, player2;
...
function onYouTubeIframeAPIReady() {
  ...
  player2 = new YT.Player('player2', {
    ...
    playerVars: {
      ...
      mute: 1,
      loop: 1,
      playlist: '_WrSFAxRZKw'
    }
  });

  // Play videos when section is in view
  const commercialSection = document.getElementById('commercial-videos');
